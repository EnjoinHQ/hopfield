...
// @filename: readContract.ts
// ---cut---
import { Abi, ExtractAbiFunctionNames } from 'hopfield'
import { abi } from './abi'
...
The preceding points are all implemented in throughout the [examples](https://github.com/propology/hopfield/tree/main/examples) in this directory so check them out if you're interested.
